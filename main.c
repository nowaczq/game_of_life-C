...
int main(int argc, char ** argv)
{
	...
	while ((opt = getopt(argc,argv,"r:m:n:f:o:")) != -1)
	{
		switch(opt)
		{
	...
	if (optind < argc)
	{
		...
		printf("Usage of app: ./game_life -r input_file_name -m output_image_name -n amout_of_iterations -f frequency_of_drawing_images -o .image_format\n");
		exit( EXIT_FAILURE );
	}
